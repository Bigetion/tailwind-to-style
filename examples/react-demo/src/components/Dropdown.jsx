...
const menuDivider = twsxClassName({ name: 'dropdown-divider', _: 'my-1 border-t border-gray-100' });
const menuLabel = twsxClassName({ name: 'dropdown-label', _: 'px-3 py-1 text-xs font-semibold text-gray-500 uppercase tracking-wider' });
