...
// This file previously kept its own separate `_ssrCollectedCss`/`_ssrCollecting`
// module state that createSSRCollector() never wrote to, so CSS generated by
// tw()/twsx() was silently dropped whenever anyone used the documented
// "modern" SSR API instead of the deprecated start/stopSSR() pair.
export { startSSR, stopSSR, getSSRStyles, createSSRCollector };
